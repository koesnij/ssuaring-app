    ...
    <View style={styles.container}>
        ...
        {loading ? (
          ...
          data.postdetail && (
            <View>
              ...
              <View style={{ alignItems: 'flex-start', flexDirection: 'row' }}>
                ...
                <View style={{ alignItems: 'flex-start' }}>
                  <Text style={{ marginLeft: 20, marginTop: 20, fontSize: 22 }}>
                    {' '}
                    {data.postdetail.user.name +
                      '(' +
                      data.postdetail.user.nickname +
                      ')'}
                  </Text>
              ...
              <Text style={{ marginLeft: 10, marginTop: 5, fontSize: 13 }}>
                {data.postdetail.category + '     ' + data.postdetail.updatedAt}
              </Text>

              <Text style={{ marginLeft: 10, marginTop: 10, fontSize: 15 }}>
                {data.postdetail.caption}{' '}
              </Text>
              <View style={{ alignItems: 'flex-start', flexDirection: 'row' }}>
      ...
      >
        <View style={{ flexDirection: 'row' }}>
          ...
          />
          <Text style={{ fontSize: 17 }}>찜하기</Text>
          <Text style={{ marginLeft: 100, fontSize: 17 }}>
            가격 : 100,000원
          </Text>
        </View>
        <Button
